...
class TestOpenCodeResponseParsing(unittest.TestCase):
    ...
    def test_extract_text_response_with_text_only(self):
        ...
        parts = [
            {"type": "text", "text": "This is a conversational response."},
            {"type": "text", "text": "With multiple text parts."},
        ]
    ...
    def test_extract_text_response_with_plan_tool_use(self):
        ...
        parts = [
            {"type": "text", "text": "I'm creating a comprehensive plan."},
            {
                "type": "tool_use",
                "tool": "write",
                "input": {
    ...
    def test_extract_text_response_with_multiple_plan_files(self):
        ...
        parts = [
            {"type": "text", "text": "Creating multiple plan files."},
            {
                "type": "tool_use",
                "tool": "write",
                "input": {
    ...
    def test_extract_text_response_ignores_non_plan_tool_use(self):
        ...
        parts = [
            {"type": "text", "text": "Working on the project."},
    ...
    def test_extract_text_response_handles_malformed_parts(self):
        ...
        parts = [
            {"type": "text", "text": "Valid text part."},
    ...
    def test_convert_opencode_to_agent_response_with_plan_content(self):
        ...
        response_data = {
            ...
            "parts": [
                {
                    "type": "text",
                    "text": "I have successfully created the comprehensive chore plan.",
                },
                {
                    "type": "tool_use",
                    "tool": "write",
...
class TestPlanContentExtractionScenarios(unittest.TestCase):
    ...
    def test_chore_plan_extraction(self):
        ...
        parts = [
            {
                "type": "text",
                "text": "I have successfully created the comprehensive chore plan for DAI-291.",
            },
            {
                "type": "tool_use",
                "tool": "write",
...
Design decisions, type safety considerations, integration points.""",
    ...
    def test_feature_plan_extraction(self):
        ...
        parts = [
            {
                "type": "text",
                "text": "I've analyzed the feature requirements and created a comprehensive implementation plan.",
            },
            {
                "type": "tool_use",
                "tool": "write",
...
- Security testing for token validation""",
    ...
    def test_bug_plan_extraction(self):
        ...
        parts = [
            {
                "type": "text",
                "text": "I've identified the root cause and created a targeted fix plan.",
            },
            {
                "type": "tool_use",
                "tool": "write",
