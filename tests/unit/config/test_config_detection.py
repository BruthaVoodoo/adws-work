"""
Unit tests for adw_config_test module - Framework Detection & Setup.

Tests framework detection, custom framework setup, and pytest plugin installation:
- Display current configuration
- Test framework detection (Jest, Pytest, Go, Rust, etc.)
- Custom framework setup
- Pytest-json-report plugin installation
