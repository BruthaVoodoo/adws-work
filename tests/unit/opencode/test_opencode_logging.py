"""
Unit tests for OpenCode logging functionality (Story 1.6).

Tests the save_response_log and log_error_with_context functions
for response logging in OpenCodeHTTPClient.
"""
