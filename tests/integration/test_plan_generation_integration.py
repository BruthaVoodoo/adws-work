...
sys.path.insert(
    0, os.path.join(os.path.dirname(__file__), "..", "unit", "integrations")
)
...
Add logging for mobile redirect attempts and failures to monitor success rate post-fix."""
        ...
        return {
            ...
            "parts": [
                {
                    "type": "text",
                    "content": f"I have successfully created the comprehensive {issue_type} plan for {issue_key}. The plan includes detailed steps, validation commands, and implementation guidance.",
                },
                {
                    "type": "tool_use",
                    "tool": "write",
